...
export function CallToAction({ text = "Загадать желание" }: { text?: string }) {
  ...
  return (
    <Link to={ROUTES.LOGIN}>
      <div className="group/CAT z-200 relative flex justify-center items-center mx-auto border-1 border-amber-400 w-fit max-w-full min-h-[4.5rem] cursor-pointer">
        ...
        />
        <GradientCircle className="-z-10 absolute opacity-0 group-hover/CAT:opacity-100 rounded-[30%] w-[30rem] aspect-video transition-opacity duration-200" />
