...
function ItemContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col flex-1 [&+[data-slot=item-content]]:flex-none gap-1",
        className
      )}
      {...props}
    />
...
function ItemTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-2 w-fit font-medium text-sm leading-snug",
        className
      )}
      {...props}
    />
...
function ItemHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex justify-between items-center gap-2 basis-full",
        className
      )}
      {...props}
    />
