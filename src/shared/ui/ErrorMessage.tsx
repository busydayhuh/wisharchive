...
export function ErrorMessage({
  ...
  return (
    <motion.div
      className="flex flex-col justify-center items-center gap-2 lg:gap-4 pt-5 md:pt-10 lg:pt-20 w-full"
      layout
    ...
    >
      <div className="[&_svg]:stroke-1 [&_svg]:size-20 text-primary">
        {ICONS[variant]}
      </div>
      <div className="flex flex-col items-center gap-2">
        <p className="w-full max-w-3xs font-headers font-semibold text-primary text-2xl text-center">
          {message.header}
        </p>
